...
test("compact human-review placement variants remain confidence gated", () => {
  for (const turn_1 of [
    ...
    "Full automation creates $800K/month contractual exposure, so 90% accuracy is not decisive. Automate only high-confidence tickets and route all others to humans. What error-rate distribution and confidence band changes the launch boundary?",
    "Full automation creates $800K/month contractual exposure, so 90% accuracy is not decisive. Automate only high-confidence tickets and route all other tickets to humans. What error-rate distribution and confidence band changes the launch boundary?",
